...
(:goal (and
	(holdblock place_1_3 blockA) (holdblock place_1_1 blockB) (holdblock place_1_2 blockD) (holdblock place_2_1 blockC)
    (holdarm place_0_4 arm1) (holdarm place_3_4 arm0))
)
)
